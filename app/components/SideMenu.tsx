const SideMenu = () => {
    return (
        <div className="w-[306px] h-[1198px] relative">
            <div className="w-[306px] h-[1198px] left-0 top-0 absolute bg-[#040440] shadow"></div>
            <div className="w-[250px] h-[46px] left-[28px] top-[128px] absolute bg-indigo-600 rounded-lg"></div>
            <div className="w-[195px] h-[39px] left-[28px] top-[36px] absolute">
                <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
                    <path d="M18.5003 34.8876C17.4674 34.8876 16.419 34.6564 15.602 34.1784L7.12284 29.2914C3.66951 26.9634 3.45367 26.6089 3.45367 22.9551V14.0443C3.45367 10.3905 3.65409 10.0359 7.04576 7.73887L15.5865 2.80553C17.2053 1.86512 19.749 1.86512 21.3678 2.80553L29.8778 7.70803C33.3311 10.0359 33.547 10.3905 33.547 14.0443V22.9397C33.547 26.5934 33.3465 26.948 29.9549 29.2451L21.414 34.1784C20.5815 34.6564 19.5332 34.8876 18.5003 34.8876ZM18.5003 4.42428C17.8528 4.42428 17.2207 4.54762 16.7736 4.8097L8.29451 9.7122C5.78159 11.408 5.78159 11.408 5.78159 14.0443V22.9397C5.78159 25.5759 5.78159 25.5759 8.35617 27.318L16.7736 32.1743C17.6832 32.6984 19.3328 32.6984 20.2424 32.1743L28.7215 27.2718C31.219 25.5759 31.219 25.5759 31.219 22.9397V14.0443C31.219 11.408 31.219 11.408 28.6445 9.66595L20.227 4.8097C19.7799 4.54762 19.1478 4.42428 18.5003 4.42428Z" fill="white" />
                    <path d="M18.5 24.2812C15.3088 24.2812 12.7188 21.6912 12.7188 18.5C12.7188 15.3088 15.3088 12.7188 18.5 12.7188C21.6912 12.7188 24.2812 15.3088 24.2812 18.5C24.2812 21.6912 21.6912 24.2812 18.5 24.2812ZM18.5 15.0312C16.5883 15.0312 15.0312 16.5883 15.0312 18.5C15.0312 20.4117 16.5883 21.9688 18.5 21.9688C20.4117 21.9688 21.9688 20.4117 21.9688 18.5C21.9688 16.5883 20.4117 15.0312 18.5 15.0312Z" fill="white" />
                </svg>
                <div className="left-[45px] top-0 absolute text-white text-[26px] font-semibold  tracking-tight cursor-pointer">Dashboard
                </div>
                <div className="w-[37px] h-[37px] left-0 top-[1px] absolute flex-col justify-start items-start inline-flex"></div>
            </div>
            <div className="w-[116px] h-6 left-[39px] top-[139px] cursor-pointer absolute">
                ...
                <div className="left-[38px] top-[1px] absolute text-white text-sm font-medium ">Dashboard</div>
            </div>
            <div className="w-[231px] h-6 left-[39px] top-[203px] absolute">
                ...
                <div className="left-[38px] top-[2px] absolute text-slate-400 text-sm font-medium  cursor-pointer">Product </div>

                <div className="w-4 h-4 left-[215px] top-[4px] absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M6 12L10 8L6 4" stroke="#9197B3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            </div>
            <div className="w-[231px] h-6 left-[39px] top-[267px] absolute">
                <div className="w-6 h-6 left-0 top-0 absolute"></div>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="left-[38px] top-[2px] absolute text-slate-400 text-sm font-medium  cursor-pointer">Customers</div>
                <div className="w-4 h-4 left-[215px] top-[4px] absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M6 12L10 8L6 4" stroke="#9197B3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <div className="w-[231px] h-6 left-[39px] top-[331px] absolute">
                <div className="w-6 h-6 left-0 top-0 absolute"></div>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="left-[38px] top-[2px] absolute text-slate-400 text-sm font-medium  cursor-pointer">Income</div>
                <div className="w-4 h-4 left-[215px] top-[4px] absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M6 12L10 8L6 4" stroke="#9197B3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <div className="w-[231px] h-6 left-[39px] top-[395px] absolute">
                <div className="w-6 h-6 left-0 top-0 absolute"></div>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="left-[38px] top-[2px] absolute text-slate-400 text-sm font-medium  cursor-pointer">Promote</div>
                <div className="w-4 h-4 left-[215px] top-[4px] absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M6 12L10 8L6 4" stroke="#9197B3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <div className="w-[231px] h-6 left-[39px] top-[459px] absolute">
                <div className="w-6 h-6 left-0 top-0 absolute"></div>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="left-[38px] top-[2px] absolute text-slate-400 text-sm font-medium  cursor-pointer">Help</div>
                <div className="w-4 h-4 left-[215px] top-[4px] absolute">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M6 12L10 8L6 4" stroke="#9197B3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <img className="w-[42px] h-[42px] left-[28px] top-[1080px] absolute rounded-full" src="Avatar.jpg" />
            <div className="w-[101px] h-[38px] left-[82px] top-[1082px] absolute">
                <div className="left-0 top-0 absolute text-white text-sm font-medium tracking-tight cursor-pointer">thisisehtesham</div>
                <div className="left-0 top-[20px] absolute text-neutral-500 text-xs font-normal tracking-tight">Software Engineer</div>
            </div>
